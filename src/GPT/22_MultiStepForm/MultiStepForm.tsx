...
export default function MultiStepForm() {
  ...
  const progressPercent = Math.round((completedCount / (totalSteps - 1)) * 100); // exclude review from progress
  ...
  function goToStep(index: number) {
    ...
    if (index > furthestVisitedStepIndex) return;
...
/* ---------- Reusable Field Components with Tailwind ---------- */
